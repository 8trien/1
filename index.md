...
feature_text: (**Chào mừng bạn đến với Nhóm**)
...
- Nghiên cứu, tổng hợp thông tin, phối hợp với supporter và viết bài.
...
- Sử dụng thành thạo các công cụ cần thiết cho quá trình làm việc như Google Drive, Google Docs, v.v.
- Có khả năng kiêm thêm một hoặc hai vai trò còn lại là một lợi thế.
 
### Hỗ trợ writer (Trans & Edit)


#### Công việc:
- Hỗ trợ trong việc dịch tư liệu dùng cho bài viết.
...
- Kiểm chứng thông tin, độ tin cậy của các nguồn trong bài viết, đối chiếu thông tin.
- Nhắc nhở và góp ý cho writer trong cách viết bài.
...
### Mô tả công việc:
- Lên ý tưởng, xây dựng kế hoạch, timeline chi tiết cho các hoạt động, sự kiện.
- Đảm bảo các hoạt động trong ngày sự kiện diễn ra theo kế hoạch đã định.
- Dự trù rủi ro và lên kế hoạch dự phòng trong những ngày diễn ra sự kiện.
